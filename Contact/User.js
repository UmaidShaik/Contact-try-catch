...
let admin = User.newAdmin("Umaid Shaikh","Male",22)
console.log(admin);
let user1 = admin.newUser("Rahul Kumar","Male",21)
console.log(user1);
let createContact=user1.createContact("Talha Shaikh","India")
console.log(createContact);
let updateContact=user1.updateContact(0,"contactName","siddhi")
console.log(updateContact);
let createContactInfo =user1.createContactInfo(0,9082722366,"Umaid@gmail.com")
console.log(createContactInfo);
let updateContactInfo=user1.updateContactInfo(0,0,"phoneNumber",1234567890)
